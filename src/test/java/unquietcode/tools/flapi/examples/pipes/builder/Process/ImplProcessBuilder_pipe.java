...
public class ImplProcessBuilder_pipe
    implements ProcessBuilder_pipe<Object> , BuilderImplementation
{
    private final ProcessHelper _helper;
    private final Object _returnValue;

    public ImplProcessBuilder_pipe(ProcessHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public ProcessBuilder_pipe addArgument(String argument) {
        _helper.addArgument(argument);
         
        return this;
    }

    public ProcessBuilder_pipe addArgument(String name, String value) {
