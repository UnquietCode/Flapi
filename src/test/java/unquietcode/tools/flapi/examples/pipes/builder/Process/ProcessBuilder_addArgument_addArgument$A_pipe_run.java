...
public interface ProcessBuilder_addArgument_addArgument$A_pipe_run<_ReturnType >{


    ProcessBuilder_addArgument_addArgument$A_pipe_run<_ReturnType> addArgument(String argument);

    ProcessBuilder_addArgument_addArgument$A_pipe_run<_ReturnType> addArgument(String name, String value);
