...
public interface PizzaBuilder_2addCheese_4f_2addTopping_32_4f<_ReturnType> {
    @MethodInfo(type = TransitionType.Lateral)
    PizzaBuilder_2addTopping_32_4f<_ReturnType> addCheese();

    @MethodInfo(type = TransitionType.Lateral)
    PizzaBuilder_2addCheese_4f_2addTopping_4f<_ReturnType> addTopping(Topping topping);
