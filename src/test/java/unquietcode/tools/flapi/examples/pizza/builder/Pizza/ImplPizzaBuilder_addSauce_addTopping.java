...
public class ImplPizzaBuilder_addSauce_addTopping
    implements PizzaBuilder_addSauce_addTopping<Object> , BuilderImplementation
{
    private final PizzaHelper _helper;
    private final Object _returnValue;

    public ImplPizzaBuilder_addSauce_addTopping(PizzaHelper helper, Object returnValue) {
        _helper = helper;
