...
public class ImplPizzaBuilder_addCheese_addTopping$3
    implements PizzaBuilder_addCheese_addTopping$3 <Object> , BuilderImplementation
{
    private final PizzaHelper _helper;
    private final Object _returnValue;

    public ImplPizzaBuilder_addCheese_addTopping$3(PizzaHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public PizzaBuilder_addTopping$3 addCheese() {
        _helper.addCheese();
    ...
    public PizzaBuilder_addCheese_addTopping$2 addTopping(Topping topping) {
        _helper.addTopping(topping);
        ImplPizzaBuilder_addCheese_addTopping$2 step1 = new ImplPizzaBuilder_addCheese_addTopping$2(_helper, _returnValue);
