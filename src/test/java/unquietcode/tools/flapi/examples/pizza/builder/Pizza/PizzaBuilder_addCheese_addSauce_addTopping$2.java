...
public interface PizzaBuilder_addCheese_addSauce_addTopping$2 <_ReturnType> {
    @MethodInfo(type = TransitionType.Lateral, chain = {

    })
    PizzaBuilder_addSauce_addTopping$2 <_ReturnType> addCheese();

    @MethodInfo(type = TransitionType.Lateral, chain = {

    })
    PizzaBuilder_addCheese_addTopping$2 <_ReturnType> addSauce(SauceType sauceType);

    @MethodInfo(type = TransitionType.Lateral, chain = {

    })
    PizzaBuilder_addCheese_addSauce_addTopping<_ReturnType> addTopping(Topping topping);
