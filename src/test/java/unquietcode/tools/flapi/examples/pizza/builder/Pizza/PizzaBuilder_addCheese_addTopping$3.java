...
public interface PizzaBuilder_addCheese_addTopping$3 <_ReturnType> {
    @MethodInfo(checkInvocations = false, checkParentInvocations = false, type = TransitionType.Lateral, chain = {

    })
    PizzaBuilder_addTopping$3 <_ReturnType> addCheese();

    @MethodInfo(checkInvocations = false, checkParentInvocations = false, type = TransitionType.Lateral, chain = {

    })
    PizzaBuilder_addCheese_addTopping$2 <_ReturnType> addTopping(Topping topping);
