...
public class ImplPizzaBuilder_addCheese_addSauce
    implements PizzaBuilder_addCheese_addSauce<Object> , BuilderImplementation
{
    private final PizzaHelper _helper;
    private final Object _returnValue;

    public ImplPizzaBuilder_addCheese_addSauce(PizzaHelper helper, Object returnValue) {
        _helper = helper;
