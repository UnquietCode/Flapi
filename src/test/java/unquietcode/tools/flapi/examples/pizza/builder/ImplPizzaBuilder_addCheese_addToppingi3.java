...
public class ImplPizzaBuilder_addCheese_addToppingi3
    implements PizzaBuilder_addCheese_addToppingi3, BuilderImplementation
{

    private final PizzaHelper _helper;
    private final BuilderImplementation _returnValue;

    ImplPizzaBuilder_addCheese_addToppingi3(PizzaHelper helper, BuilderImplementation returnValue) {
        _helper = helper;
