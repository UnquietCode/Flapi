...
public interface PizzaBuilder_2addCheese_2addSauce_2addTopping<_ReturnType> {
    @MethodInfo(type = TransitionType.Lateral)
    PizzaBuilder_2addSauce_2addTopping<_ReturnType> addCheese();

    @MethodInfo(type = TransitionType.Lateral)
    PizzaBuilder_2addCheese_2addTopping<_ReturnType> addSauce(SauceType sauceType);

    @MethodInfo(type = TransitionType.Lateral)
    PizzaBuilder_2addCheese_2addSauce<_ReturnType> addTopping(Topping topping);
