...
public interface PizzaBuilder_2addCheese_2addTopping_32 <_ReturnType> {
    @MethodInfo(type = TransitionType.Lateral)
    PizzaBuilder_2addTopping_32 <_ReturnType> addCheese();

    @MethodInfo(type = TransitionType.Lateral)
    PizzaBuilder_2addCheese_2addTopping<_ReturnType> addTopping(Topping topping);
