...
public class ImplPizzaBuilder_addSauce_addTopping
    implements PizzaBuilder_addSauce_addTopping, BuilderImplementation
{

    private final PizzaHelper _helper;
    private final BuilderImplementation _returnValue;

    ImplPizzaBuilder_addSauce_addTopping(PizzaHelper helper, BuilderImplementation returnValue) {
        _helper = helper;
