...
public interface PizzaBuilder_addSauce_addTopping$3 <_ReturnType> {
    @MethodInfo(type = TransitionType.Lateral, chain = {

    })
    PizzaBuilder_addTopping$3 <_ReturnType> addSauce(SauceType sauceType);

    @MethodInfo(type = TransitionType.Lateral, chain = {

    })
    PizzaBuilder_addSauce_addTopping$2 <_ReturnType> addTopping(Topping topping);
