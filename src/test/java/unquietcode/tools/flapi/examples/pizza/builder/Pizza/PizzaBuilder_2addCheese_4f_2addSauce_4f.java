...
public interface PizzaBuilder_2addCheese_4f_2addSauce_4f<_ReturnType> {
    @MethodInfo(type = TransitionType.Lateral)
    PizzaBuilder_2addSauce_4f<_ReturnType> addCheese();

    @MethodInfo(type = TransitionType.Lateral)
    PizzaBuilder_2addCheese_4f<_ReturnType> addSauce(SauceType sauceType);
