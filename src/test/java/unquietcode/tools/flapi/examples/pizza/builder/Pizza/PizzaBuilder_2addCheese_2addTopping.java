...
public interface PizzaBuilder_2addCheese_2addTopping<_ReturnType> {
    @MethodInfo(type = TransitionType.Lateral)
    PizzaBuilder_2addTopping<_ReturnType> addCheese();

    @MethodInfo(type = TransitionType.Lateral)
    PizzaBuilder_2addCheese<_ReturnType> addTopping(Topping topping);
