...
public interface PizzaBuilder_addCheese_addToppingi3 <_ReturnType >{


    unquietcode.tools.flapi.examples.pizza.DisappearingPizzaExample.Pizza bake();

    PizzaBuilder_addToppingi3 <_ReturnType> addCheese();

    PizzaBuilder_addCheese_addToppingi2 <_ReturnType> addTopping(Topping topping);
