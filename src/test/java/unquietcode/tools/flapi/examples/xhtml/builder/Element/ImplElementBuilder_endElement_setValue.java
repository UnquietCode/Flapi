...
public class ImplElementBuilder_endElement_setValue
    implements ElementBuilder_endElement_setValue<Object> , BuilderImplementation
{
    private final ElementHelper _helper;
    private final Object _returnValue;

    public ImplElementBuilder_endElement_setValue(ElementHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public ElementBuilder_endElement_setValue addAttribute(String key, String value) {
        _helper.addAttribute(key, value);
         
        return this;
    }

    public ElementBuilder_endElement_setValue addComment(String comment) {
    ...
    public ElementBuilder_endElement setValue(String value) {
        _helper.setValue(value);
        ImplElementBuilder_endElement step1 = new ImplElementBuilder_endElement(_helper, _returnValue);
