...
public interface EmailBuilder_2addAttachment_2addBCC_2addCC_2addRecipient_2sender<_ReturnType> {
    @MethodInfo(type = TransitionType.Recursive)
    EmailBuilder_2addAttachment_2addBCC_2addCC_2addRecipient_2sender<_ReturnType> addAttachment(File file);

    @MethodInfo(type = TransitionType.Recursive)
    EmailBuilder_2addAttachment_2addBCC_2addCC_2addRecipient_2sender<_ReturnType> addBCC(String emailAddress);

    @MethodInfo(type = TransitionType.Recursive)
    EmailBuilder_2addAttachment_2addBCC_2addCC_2addRecipient_2sender<_ReturnType> addCC(String emailAddress);

    @MethodInfo(type = TransitionType.Recursive)
    @Tracked(atLeast = 1, key = "addRecipient_1String_emailAddre")
    EmailBuilder_2addAttachment_2addBCC_2addCC_2addRecipient_2sender<_ReturnType> addRecipient(String emailAddress);
    ...
    EmailBuilder_2addAttachment_2addBCC_2addCC_2addRecipient<_ReturnType> sender(String emailAddress);
}
