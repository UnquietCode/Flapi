 ...
 * 
 */
public class ImplEmailBuilder_setBody_setSender
    implements EmailBuilder_setBody_setSender
{
    ...
    ImplEmailBuilder_setBody_setSender(EmailHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public EmailBuilder_setBody_setSender addAttachment(File file) {
        _helper.addAttachment(file);
         
        EmailBuilder_setBody_setSender retval = this;
        return retval;
    }

    public EmailBuilder_setBody_setSender addBCC(String emailAddress) {
    ...
    public EmailBuilder_setBody_setSender addCC(String emailAddress) {
    ...
    public EmailBuilder_setBody_setSender addRecipient(String emailAddress) {
    ...
    public EmailBuilder_setSender setBody(String text) {
