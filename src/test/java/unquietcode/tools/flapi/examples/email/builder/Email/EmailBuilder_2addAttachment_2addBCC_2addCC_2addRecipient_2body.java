...
public interface EmailBuilder_2addAttachment_2addBCC_2addCC_2addRecipient_2body<_ReturnType> {
    @MethodInfo(type = TransitionType.Recursive)
    EmailBuilder_2addAttachment_2addBCC_2addCC_2addRecipient_2body<_ReturnType> addAttachment(File file);

    @MethodInfo(type = TransitionType.Recursive)
    EmailBuilder_2addAttachment_2addBCC_2addCC_2addRecipient_2body<_ReturnType> addBCC(String emailAddress);

    @MethodInfo(type = TransitionType.Recursive)
    EmailBuilder_2addAttachment_2addBCC_2addCC_2addRecipient_2body<_ReturnType> addCC(String emailAddress);

    @MethodInfo(type = TransitionType.Recursive)
    @Tracked(atLeast = 1, key = "addRecipient_1String_emailAddre")
    EmailBuilder_2addAttachment_2addBCC_2addCC_2addRecipient_2body<_ReturnType> addRecipient(String emailAddress);

    @MethodInfo(type = TransitionType.Lateral)
    EmailBuilder_2addAttachment_2addBCC_2addCC_2addRecipient<_ReturnType> body(String text);
