 ...
 * 
 */
public class ImplEmailBuilder_setSender_setSubject
    implements EmailBuilder_setSender_setSubject
{
    ...
    ImplEmailBuilder_setSender_setSubject(EmailHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public EmailBuilder_setSender_setSubject addAttachment(File file) {
        _helper.addAttachment(file);
         
        EmailBuilder_setSender_setSubject retval = this;
        return retval;
    }

    public EmailBuilder_setSender_setSubject addBCC(String emailAddress) {
    ...
    public EmailBuilder_setSender_setSubject addCC(String emailAddress) {
    ...
    public EmailBuilder_setSender_setSubject addRecipient(String emailAddress) {
    ...
    public EmailBuilder_setSender setSubject(String subject) {
        _helper.setSubject(subject);
         
        EmailBuilder_setSender retval = new ImplEmailBuilder_setSender(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }
