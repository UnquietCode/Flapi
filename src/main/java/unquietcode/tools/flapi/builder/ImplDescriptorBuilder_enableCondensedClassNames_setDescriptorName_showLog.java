 ...
 * 
 */
public class ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_showLog
    implements DescriptorBuilder_enableCondensedClassNames_setDescriptorName_showLog
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setDescriptorName_showLog enableCondensedClassNames(boolean value) {
        _helper.enableCondensedClassNames(value);
         
        DescriptorBuilder_setDescriptorName_showLog retval = new ImplDescriptorBuilder_setDescriptorName_showLog(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_showLog setDescriptorName(String descriptorName) {
    ...
    public DescriptorBuilder_enableCondensedClassNames_setDescriptorName showLog(boolean value) {
