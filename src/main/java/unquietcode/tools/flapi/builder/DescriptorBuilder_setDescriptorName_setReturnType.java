...
public interface DescriptorBuilder_setDescriptorName_setReturnType<_ReturnType >{
    ...
    MethodBuilder_addBlockChain<BlockBuilder_exitWhenEmpty<DescriptorBuilder_setDescriptorName_setReturnType<_ReturnType>>> startBlock(String blockName, String methodSignature);
