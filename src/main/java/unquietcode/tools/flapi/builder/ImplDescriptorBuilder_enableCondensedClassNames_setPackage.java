...
public class ImplDescriptorBuilder_enableCondensedClassNames_setPackage
    implements DescriptorBuilder_enableCondensedClassNames_setPackage, BuilderImplementation
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setPackage(DescriptorHelper helper, BuilderImplementation parent) {
        _helper = helper;
        _parent = parent;
    }
    ...
    public DescriptorBuilder_setPackage enableCondensedClassNames() {
