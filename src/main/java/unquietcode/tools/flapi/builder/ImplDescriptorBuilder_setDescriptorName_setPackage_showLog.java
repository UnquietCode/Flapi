 ...
 * 
 */
public class ImplDescriptorBuilder_setDescriptorName_setPackage_showLog
    implements DescriptorBuilder_setDescriptorName_setPackage_showLog
{
    ...
    ImplDescriptorBuilder_setDescriptorName_setPackage_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setPackage_showLog setDescriptorName(String descriptorName) {
