 ...
 * 
 */
public class ImplDescriptorBuilder_setDescriptorName_setStartingMethodName_showLog
    implements DescriptorBuilder_setDescriptorName_setStartingMethodName_showLog
{
    ...
    ImplDescriptorBuilder_setDescriptorName_setStartingMethodName_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setStartingMethodName_showLog setDescriptorName(String descriptorName) {
