...
public class ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setPackage
    implements DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setPackage
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setPackage(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setDescriptorName_setPackage enableCondensedClassNames(boolean value) {
