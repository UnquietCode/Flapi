...
public class ImplDescriptorBuilder_setReturnType
    implements DescriptorBuilder_setReturnType, BuilderImplementation
{
    ...
    ImplDescriptorBuilder_setReturnType(DescriptorHelper helper, BuilderImplementation returnValue) {
        _helper = helper;
