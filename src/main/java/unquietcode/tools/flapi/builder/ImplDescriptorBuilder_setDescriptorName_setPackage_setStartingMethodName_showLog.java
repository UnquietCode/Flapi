 ...
 * 
 */
public class ImplDescriptorBuilder_setDescriptorName_setPackage_setStartingMethodName_showLog
    implements DescriptorBuilder_setDescriptorName_setPackage_setStartingMethodName_showLog
{
    ...
    ImplDescriptorBuilder_setDescriptorName_setPackage_setStartingMethodName_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setPackage_setStartingMethodName_showLog setDescriptorName(String descriptorName) {
    ...
    public DescriptorBuilder_setDescriptorName_setStartingMethodName_showLog setPackage(String packageName) {
    ...
    public DescriptorBuilder_setDescriptorName_setPackage_showLog setStartingMethodName(String methodName) {
