...
public class ImplDescriptorBuilder_setDescriptorName_setStartingMethodName_setPackage
    extends ImplDescriptorBuilder
    implements DescriptorBuilder_setDescriptorName_setStartingMethodName_setPackage
{


    ImplDescriptorBuilder_setDescriptorName_setStartingMethodName_setPackage(DescriptorHelper helper, Object returnValue) {
        super(helper, returnValue);
    }

    public DescriptorBuilder_setStartingMethodName_setPackage setDescriptorName(String descriptorName) {
