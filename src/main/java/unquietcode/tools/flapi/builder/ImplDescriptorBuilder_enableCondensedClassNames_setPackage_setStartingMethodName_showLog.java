 ...
 * 
 */
public class ImplDescriptorBuilder_enableCondensedClassNames_setPackage_setStartingMethodName_showLog
    implements DescriptorBuilder_enableCondensedClassNames_setPackage_setStartingMethodName_showLog
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setPackage_setStartingMethodName_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setPackage_setStartingMethodName_showLog enableCondensedClassNames(boolean value) {
        _helper.enableCondensedClassNames(value);
         
        DescriptorBuilder_setPackage_setStartingMethodName_showLog retval = new ImplDescriptorBuilder_setPackage_setStartingMethodName_showLog(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_setStartingMethodName_showLog setPackage(String packageName) {
    ...
    public DescriptorBuilder_enableCondensedClassNames_setPackage_showLog setStartingMethodName(String methodName) {
    ...
    public DescriptorBuilder_enableCondensedClassNames_setPackage_setStartingMethodName showLog(boolean value) {
