...
public class ImplDescriptorBuilder_enableCondensedClassNames_setStartingMethodName
    implements DescriptorBuilder_enableCondensedClassNames_setStartingMethodName
{
    ...
    public DescriptorBuilder_setStartingMethodName enableCondensedClassNames(boolean value) {
