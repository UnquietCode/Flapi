...
public class ImplDescriptorBuilder_enableCondensedClassNames_setStartingMethodName
    implements DescriptorBuilder_enableCondensedClassNames_setStartingMethodName, BuilderImplementation
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setStartingMethodName(DescriptorHelper helper, BuilderImplementation parent) {
        _helper = helper;
        _parent = parent;
    }
    ...
    public DescriptorBuilder_setStartingMethodName enableCondensedClassNames() {
    ...
    public DescriptorBuilder_enableCondensedClassNames setStartingMethodName(String methodName) {
        _helper.setStartingMethodName(methodName);
         
        DescriptorBuilder_enableCondensedClassNames retval = new ImplDescriptorBuilder_enableCondensedClassNames(_helper, _parent);
        _transferInvocations(retval);
        return retval;
    }
