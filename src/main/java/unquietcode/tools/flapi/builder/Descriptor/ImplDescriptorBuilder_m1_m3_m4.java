...
public class ImplDescriptorBuilder_m1_m3_m4
    implements DescriptorBuilder_m1_m3_m4, BuilderImplementation
{
    private final DescriptorHelper _helper;
    private final Object _returnValue;
    int ic_Descriptor_setPackage$String_packageName = 1;

    public ImplDescriptorBuilder_m1_m3_m4(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
     ...
     */
    public DescriptorBuilder_m3_m4 enableCondensedClassNames() {
     ...
     */
    public DescriptorBuilder_m1_m4 setPackage(String packageName) {
        --ic_Descriptor_setPackage$String_packageName;
        _helper.setPackage(packageName);
        ImplDescriptorBuilder_m1_m4 step1 = new ImplDescriptorBuilder_m1_m4(_helper, _returnValue);
     ...
     */
    public DescriptorBuilder_m1_m3 setReturnType(Class returnType) {
        _helper.setReturnType(returnType);
        ImplDescriptorBuilder_m1_m3 step1 = new ImplDescriptorBuilder_m1_m3(_helper, _returnValue);
