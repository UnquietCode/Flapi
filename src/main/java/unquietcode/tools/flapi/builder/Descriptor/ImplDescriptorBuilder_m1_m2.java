...
public class ImplDescriptorBuilder_m1_m2
    implements DescriptorBuilder_m1_m2, BuilderImplementation
{
    private final DescriptorHelper _helper;
    private final Object _returnValue;
    int ic_Descriptor_setDescriptorName$String_descriptorName = 1;

    public ImplDescriptorBuilder_m1_m2(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
     ...
     */
    public DescriptorBuilder_m2 enableCondensedClassNames() {
     ...
     */
    public DescriptorBuilder_m1 setDescriptorName(String descriptorName) {
        --ic_Descriptor_setDescriptorName$String_descriptorName;
        _helper.setDescriptorName(descriptorName);
        ImplDescriptorBuilder_m1 step1 = new ImplDescriptorBuilder_m1(_helper, _returnValue);
