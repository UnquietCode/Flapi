...
public class ImplDescriptorBuilder_m2_m3_m4_m5
    implements DescriptorBuilder_m2_m3_m4_m5, BuilderImplementation
{
    ...
    public ImplDescriptorBuilder_m2_m3_m4_m5(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
     ...
     */
    public DescriptorBuilder_m3_m4_m5 setDescriptorName(String descriptorName) {
        --ic_Descriptor_setDescriptorName$String_descriptorName;
        _helper.setDescriptorName(descriptorName);
        ImplDescriptorBuilder_m3_m4_m5 step1 = new ImplDescriptorBuilder_m3_m4_m5(_helper, _returnValue);
     ...
     */
    public DescriptorBuilder_m2_m4_m5 setPackage(String packageName) {
        --ic_Descriptor_setPackage$String_packageName;
        _helper.setPackage(packageName);
        ImplDescriptorBuilder_m2_m4_m5 step1 = new ImplDescriptorBuilder_m2_m4_m5(_helper, _returnValue);
     ...
     */
    public DescriptorBuilder_m2_m3_m5 setReturnType(Class returnType) {
        _helper.setReturnType(returnType);
        ImplDescriptorBuilder_m2_m3_m5 step1 = new ImplDescriptorBuilder_m2_m3_m5(_helper, _returnValue);
     ...
     */
    public DescriptorBuilder_m2_m3_m4 setStartingMethodName(String methodName) {
        _helper.setStartingMethodName(methodName);
        ImplDescriptorBuilder_m2_m3_m4 step1 = new ImplDescriptorBuilder_m2_m3_m4(_helper, _returnValue);
