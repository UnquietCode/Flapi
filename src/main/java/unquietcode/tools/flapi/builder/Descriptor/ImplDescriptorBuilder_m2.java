...
public class ImplDescriptorBuilder_m2
    implements DescriptorBuilder_m2, BuilderImplementation
{
    private final DescriptorHelper _helper;
    private final Object _returnValue;
    int ic_Descriptor_setDescriptorName$String_descriptorName = 1;

    public ImplDescriptorBuilder_m2(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
