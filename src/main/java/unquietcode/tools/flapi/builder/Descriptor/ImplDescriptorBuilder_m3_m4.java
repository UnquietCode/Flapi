...
public class ImplDescriptorBuilder_m3_m4
    implements DescriptorBuilder_m3_m4, BuilderImplementation
{
    private final DescriptorHelper _helper;
    private final Object _returnValue;
    int ic_Descriptor_setPackage$String_packageName = 1;

    public ImplDescriptorBuilder_m3_m4(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
     ...
     */
    public DescriptorBuilder_m4 setPackage(String packageName) {
     ...
     */
    public DescriptorBuilder_m3 setReturnType(Class returnType) {
