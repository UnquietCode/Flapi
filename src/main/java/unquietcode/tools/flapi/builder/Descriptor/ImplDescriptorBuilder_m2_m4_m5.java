...
public class ImplDescriptorBuilder_m2_m4_m5
    implements DescriptorBuilder_m2_m4_m5, BuilderImplementation
{
    private final DescriptorHelper _helper;
    private final Object _returnValue;
    int ic_Descriptor_setDescriptorName$String_descriptorName = 1;

    public ImplDescriptorBuilder_m2_m4_m5(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
     ...
     */
    public DescriptorBuilder_m4_m5 setDescriptorName(String descriptorName) {
     ...
     */
    public DescriptorBuilder_m2_m5 setReturnType(Class returnType) {
     ...
     */
    public DescriptorBuilder_m2_m4 setStartingMethodName(String methodName) {
