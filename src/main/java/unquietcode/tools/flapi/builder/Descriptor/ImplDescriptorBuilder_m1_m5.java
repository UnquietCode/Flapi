...
public class ImplDescriptorBuilder_m1_m5
    implements DescriptorBuilder_m1_m5, BuilderImplementation
{
    private final DescriptorHelper _helper;
    private final Object _returnValue;

    public ImplDescriptorBuilder_m1_m5(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
     ...
     */
    public DescriptorBuilder_m5 enableCondensedClassNames() {
     ...
     */
    public DescriptorBuilder_m1 setStartingMethodName(String methodName) {
