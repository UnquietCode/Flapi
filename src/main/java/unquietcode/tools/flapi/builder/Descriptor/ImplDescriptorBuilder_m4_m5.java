...
public class ImplDescriptorBuilder_m4_m5
    implements DescriptorBuilder_m4_m5, BuilderImplementation
{
    private final DescriptorHelper _helper;
    private final Object _returnValue;

    public ImplDescriptorBuilder_m4_m5(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
     ...
     */
    public DescriptorBuilder_m5 setReturnType(Class returnType) {
     ...
     */
    public DescriptorBuilder_m4 setStartingMethodName(String methodName) {
        _helper.setStartingMethodName(methodName);
        ImplDescriptorBuilder_m4 step1 = new ImplDescriptorBuilder_m4(_helper, _returnValue);
