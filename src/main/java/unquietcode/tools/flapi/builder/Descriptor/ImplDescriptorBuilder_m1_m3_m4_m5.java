...
public class ImplDescriptorBuilder_m1_m3_m4_m5
    implements DescriptorBuilder_m1_m3_m4_m5, BuilderImplementation
{
    private final DescriptorHelper _helper;
    private final Object _returnValue;
    int ic_Descriptor_setPackage$String_packageName = 1;

    public ImplDescriptorBuilder_m1_m3_m4_m5(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
     ...
     */
    public DescriptorBuilder_m3_m4_m5 enableCondensedClassNames() {
     ...
     */
    public DescriptorBuilder_m1_m4_m5 setPackage(String packageName) {
     ...
     */
    public DescriptorBuilder_m1_m3_m5 setReturnType(Class returnType) {
     ...
     */
    public DescriptorBuilder_m1_m3_m4 setStartingMethodName(String methodName) {
        _helper.setStartingMethodName(methodName);
        ImplDescriptorBuilder_m1_m3_m4 step1 = new ImplDescriptorBuilder_m1_m3_m4(_helper, _returnValue);
