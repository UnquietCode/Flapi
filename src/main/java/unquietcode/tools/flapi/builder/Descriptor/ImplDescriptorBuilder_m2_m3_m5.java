...
public class ImplDescriptorBuilder_m2_m3_m5
    implements DescriptorBuilder_m2_m3_m5, BuilderImplementation
{
    ...
    public ImplDescriptorBuilder_m2_m3_m5(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
     ...
     */
    public DescriptorBuilder_m3_m5 setDescriptorName(String descriptorName) {
     ...
     */
    public DescriptorBuilder_m2_m5 setPackage(String packageName) {
     ...
     */
    public DescriptorBuilder_m2_m3 setStartingMethodName(String methodName) {
