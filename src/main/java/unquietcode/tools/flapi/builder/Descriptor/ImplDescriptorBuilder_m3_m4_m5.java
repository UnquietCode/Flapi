...
public class ImplDescriptorBuilder_m3_m4_m5
    implements DescriptorBuilder_m3_m4_m5, BuilderImplementation
{
    private final DescriptorHelper _helper;
    private final Object _returnValue;
    int ic_Descriptor_setPackage$String_packageName = 1;

    public ImplDescriptorBuilder_m3_m4_m5(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
     ...
     */
    public DescriptorBuilder_m4_m5 setPackage(String packageName) {
        --ic_Descriptor_setPackage$String_packageName;
        _helper.setPackage(packageName);
        ImplDescriptorBuilder_m4_m5 step1 = new ImplDescriptorBuilder_m4_m5(_helper, _returnValue);
     ...
     */
    public DescriptorBuilder_m3_m5 setReturnType(Class returnType) {
        _helper.setReturnType(returnType);
        ImplDescriptorBuilder_m3_m5 step1 = new ImplDescriptorBuilder_m3_m5(_helper, _returnValue);
     ...
     */
    public DescriptorBuilder_m3_m4 setStartingMethodName(String methodName) {
        _helper.setStartingMethodName(methodName);
        ImplDescriptorBuilder_m3_m4 step1 = new ImplDescriptorBuilder_m3_m4(_helper, _returnValue);
