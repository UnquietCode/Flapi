...
public class ImplDescriptorBuilder_m2_m5
    implements DescriptorBuilder_m2_m5, BuilderImplementation
{
    private final DescriptorHelper _helper;
    private final Object _returnValue;
    int ic_Descriptor_setDescriptorName$String_descriptorName = 1;

    public ImplDescriptorBuilder_m2_m5(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
     ...
     */
    public DescriptorBuilder_m5 setDescriptorName(String descriptorName) {
        --ic_Descriptor_setDescriptorName$String_descriptorName;
        _helper.setDescriptorName(descriptorName);
        ImplDescriptorBuilder_m5 step1 = new ImplDescriptorBuilder_m5(_helper, _returnValue);
     ...
     */
    public DescriptorBuilder_m2 setStartingMethodName(String methodName) {
        _helper.setStartingMethodName(methodName);
        ImplDescriptorBuilder_m2 step1 = new ImplDescriptorBuilder_m2(_helper, _returnValue);
