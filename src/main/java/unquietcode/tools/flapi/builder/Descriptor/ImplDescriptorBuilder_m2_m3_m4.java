...
public class ImplDescriptorBuilder_m2_m3_m4
    implements DescriptorBuilder_m2_m3_m4, BuilderImplementation
{
    ...
    public ImplDescriptorBuilder_m2_m3_m4(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
     ...
     */
    public DescriptorBuilder_m3_m4 setDescriptorName(String descriptorName) {
     ...
     */
    public DescriptorBuilder_m2_m4 setPackage(String packageName) {
        --ic_Descriptor_setPackage$String_packageName;
        _helper.setPackage(packageName);
        ImplDescriptorBuilder_m2_m4 step1 = new ImplDescriptorBuilder_m2_m4(_helper, _returnValue);
     ...
     */
    public DescriptorBuilder_m2_m3 setReturnType(Class returnType) {
        _helper.setReturnType(returnType);
        ImplDescriptorBuilder_m2_m3 step1 = new ImplDescriptorBuilder_m2_m3(_helper, _returnValue);
