...
public class ImplDescriptorBuilder_m2_m3
    implements DescriptorBuilder_m2_m3, BuilderImplementation
{
    ...
    public ImplDescriptorBuilder_m2_m3(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
     ...
     */
    public DescriptorBuilder_m3 setDescriptorName(String descriptorName) {
        --ic_Descriptor_setDescriptorName$String_descriptorName;
        _helper.setDescriptorName(descriptorName);
        ImplDescriptorBuilder_m3 step1 = new ImplDescriptorBuilder_m3(_helper, _returnValue);
     ...
     */
    public DescriptorBuilder_m2 setPackage(String packageName) {
