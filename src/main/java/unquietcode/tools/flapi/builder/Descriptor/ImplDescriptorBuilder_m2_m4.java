...
public class ImplDescriptorBuilder_m2_m4
    implements DescriptorBuilder_m2_m4, BuilderImplementation
{
    private final DescriptorHelper _helper;
    private final Object _returnValue;
    int ic_Descriptor_setDescriptorName$String_descriptorName = 1;

    public ImplDescriptorBuilder_m2_m4(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
     ...
     */
    public DescriptorBuilder_m4 setDescriptorName(String descriptorName) {
     ...
     */
    public DescriptorBuilder_m2 setReturnType(Class returnType) {
