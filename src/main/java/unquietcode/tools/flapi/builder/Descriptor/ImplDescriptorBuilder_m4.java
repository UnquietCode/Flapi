...
public class ImplDescriptorBuilder_m4
    implements DescriptorBuilder_m4, BuilderImplementation
{
    private final DescriptorHelper _helper;
    private final Object _returnValue;

    public ImplDescriptorBuilder_m4(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
