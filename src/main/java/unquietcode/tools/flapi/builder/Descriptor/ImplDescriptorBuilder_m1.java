...
public class ImplDescriptorBuilder_m1
    implements DescriptorBuilder_m1, BuilderImplementation
{
    private final DescriptorHelper _helper;
    private final Object _returnValue;

    public ImplDescriptorBuilder_m1(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
