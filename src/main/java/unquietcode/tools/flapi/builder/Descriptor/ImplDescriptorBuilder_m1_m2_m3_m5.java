...
public class ImplDescriptorBuilder_m1_m2_m3_m5
    implements DescriptorBuilder_m1_m2_m3_m5, BuilderImplementation
{
    ...
    public ImplDescriptorBuilder_m1_m2_m3_m5(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
     ...
     */
    public DescriptorBuilder_m2_m3_m5 enableCondensedClassNames() {
     ...
     */
    public DescriptorBuilder_m1_m3_m5 setDescriptorName(String descriptorName) {
        --ic_Descriptor_setDescriptorName$String_descriptorName;
        _helper.setDescriptorName(descriptorName);
        ImplDescriptorBuilder_m1_m3_m5 step1 = new ImplDescriptorBuilder_m1_m3_m5(_helper, _returnValue);
     ...
     */
    public DescriptorBuilder_m1_m2_m5 setPackage(String packageName) {
     ...
     */
    public DescriptorBuilder_m1_m2_m3 setStartingMethodName(String methodName) {
        _helper.setStartingMethodName(methodName);
        ImplDescriptorBuilder_m1_m2_m3 step1 = new ImplDescriptorBuilder_m1_m2_m3(_helper, _returnValue);
