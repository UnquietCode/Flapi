...
public class ImplDescriptorBuilder_m1_m3
    implements DescriptorBuilder_m1_m3, BuilderImplementation
{
    private final DescriptorHelper _helper;
    private final Object _returnValue;
    int ic_Descriptor_setPackage$String_packageName = 1;

    public ImplDescriptorBuilder_m1_m3(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
     ...
     */
    public DescriptorBuilder_m3 enableCondensedClassNames() {
     ...
     */
    public DescriptorBuilder_m1 setPackage(String packageName) {
