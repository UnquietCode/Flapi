 ...
 * 
 */
public class ImplDescriptorBuilder_setPackage_setReturnType_setStartingMethodName_showLog
    implements DescriptorBuilder_setPackage_setReturnType_setStartingMethodName_showLog
{
    ...
    ImplDescriptorBuilder_setPackage_setReturnType_setStartingMethodName_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setReturnType_setStartingMethodName_showLog setPackage(String packageName) {
    ...
    public DescriptorBuilder_setPackage_setStartingMethodName_showLog setReturnType(Class returnType) {
    ...
    public DescriptorBuilder_setPackage_setReturnType_showLog setStartingMethodName(String methodName) {
    ...
    public DescriptorBuilder_setPackage_setReturnType_setStartingMethodName showLog(boolean value) {
