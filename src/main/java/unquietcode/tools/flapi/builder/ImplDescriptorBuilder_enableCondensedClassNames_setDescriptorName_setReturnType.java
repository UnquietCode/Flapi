...
public class ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setReturnType
    implements DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setReturnType, BuilderImplementation
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setReturnType(DescriptorHelper helper, BuilderImplementation returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setDescriptorName_setReturnType enableCondensedClassNames() {
    ...
    public DescriptorBuilder_enableCondensedClassNames_setReturnType setDescriptorName(String descriptorName) {
    ...
    public DescriptorBuilder_enableCondensedClassNames_setDescriptorName setReturnType(Class returnType) {
