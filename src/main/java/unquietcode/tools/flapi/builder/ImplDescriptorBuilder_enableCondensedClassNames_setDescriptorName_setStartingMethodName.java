...
public class ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setStartingMethodName
    implements DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setStartingMethodName, BuilderImplementation
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setStartingMethodName(DescriptorHelper helper, BuilderImplementation returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setDescriptorName_setStartingMethodName enableCondensedClassNames() {
        _helper.enableCondensedClassNames();
         
        DescriptorBuilder_setDescriptorName_setStartingMethodName retval = new ImplDescriptorBuilder_setDescriptorName_setStartingMethodName(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_setStartingMethodName setDescriptorName(String descriptorName) {
        --ic_Descriptor_setDescriptorName$String_descriptorName;
        _helper.setDescriptorName(descriptorName);
         
        DescriptorBuilder_enableCondensedClassNames_setStartingMethodName retval = new ImplDescriptorBuilder_enableCondensedClassNames_setStartingMethodName(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_setDescriptorName setStartingMethodName(String methodName) {
        _helper.setStartingMethodName(methodName);
         
        DescriptorBuilder_enableCondensedClassNames_setDescriptorName retval = new ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }
