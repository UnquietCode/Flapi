...
public class ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setStartingMethodName
    implements DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setStartingMethodName
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setStartingMethodName(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setDescriptorName_setStartingMethodName enableCondensedClassNames(boolean value) {
