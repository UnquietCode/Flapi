    ...
    implements DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setStartingMethodName, BuilderImplementation
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setStartingMethodName(DescriptorHelper helper, BuilderImplementation parent) {
        _helper = helper;
        _parent = parent;
    }
    ...
    public DescriptorBuilder_setDescriptorName_setStartingMethodName enableCondensedClassNames() {
        ...
        DescriptorBuilder_setDescriptorName_setStartingMethodName retval = new ImplDescriptorBuilder_setDescriptorName_setStartingMethodName(_helper, _parent);
    ...
    public DescriptorBuilder_enableCondensedClassNames_setStartingMethodName setDescriptorName(String descriptorName) {
        ...
        DescriptorBuilder_enableCondensedClassNames_setStartingMethodName retval = new ImplDescriptorBuilder_enableCondensedClassNames_setStartingMethodName(_helper, _parent);
        _transferInvocations(retval);
        return retval;
    }
    ...
    public DescriptorBuilder_enableCondensedClassNames_setDescriptorName setStartingMethodName(String methodName) {
        ...
        DescriptorBuilder_enableCondensedClassNames_setDescriptorName retval = new ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName(_helper, _parent);
        _transferInvocations(retval);
        return retval;
    }
