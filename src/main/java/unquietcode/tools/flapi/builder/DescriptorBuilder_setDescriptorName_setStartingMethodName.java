...
public interface DescriptorBuilder_setDescriptorName_setStartingMethodName<_ReturnType >{
    ...
    MethodBuilder_addBlockChain<DescriptorBuilder_setDescriptorName_setStartingMethodName<_ReturnType>> addBlockReference(String blockName, String methodSignature);

    DescriptorBuilder_setStartingMethodName<_ReturnType> setDescriptorName(String descriptorName);

    MethodBuilder_addBlockChain<BlockBuilder<DescriptorBuilder_setDescriptorName_setStartingMethodName<_ReturnType>>> startBlock(String methodSignature);
