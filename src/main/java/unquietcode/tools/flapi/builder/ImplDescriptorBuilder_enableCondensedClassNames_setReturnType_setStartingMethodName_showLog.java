 ...
 * 
 */
public class ImplDescriptorBuilder_enableCondensedClassNames_setReturnType_setStartingMethodName_showLog
    implements DescriptorBuilder_enableCondensedClassNames_setReturnType_setStartingMethodName_showLog
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setReturnType_setStartingMethodName_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setReturnType_setStartingMethodName_showLog enableCondensedClassNames(boolean value) {
        _helper.enableCondensedClassNames(value);
         
        DescriptorBuilder_setReturnType_setStartingMethodName_showLog retval = new ImplDescriptorBuilder_setReturnType_setStartingMethodName_showLog(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_setStartingMethodName_showLog setReturnType(Class returnType) {
        _helper.setReturnType(returnType);
         
        DescriptorBuilder_enableCondensedClassNames_setStartingMethodName_showLog retval = new ImplDescriptorBuilder_enableCondensedClassNames_setStartingMethodName_showLog(_helper, _returnValue);
        --ic_Descriptor_setReturnType$Class_returnType;
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_setReturnType_showLog setStartingMethodName(String methodName) {
        _helper.setStartingMethodName(methodName);
         
        DescriptorBuilder_enableCondensedClassNames_setReturnType_showLog retval = new ImplDescriptorBuilder_enableCondensedClassNames_setReturnType_showLog(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_setReturnType_setStartingMethodName showLog(boolean value) {
        _helper.showLog(value);
         
        DescriptorBuilder_enableCondensedClassNames_setReturnType_setStartingMethodName retval = new ImplDescriptorBuilder_enableCondensedClassNames_setReturnType_setStartingMethodName(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }
