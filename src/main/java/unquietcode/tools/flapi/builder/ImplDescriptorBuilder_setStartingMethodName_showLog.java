 ...
 * 
 */
public class ImplDescriptorBuilder_setStartingMethodName_showLog
    implements DescriptorBuilder_setStartingMethodName_showLog
{
    ...
    ImplDescriptorBuilder_setStartingMethodName_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_showLog setStartingMethodName(String methodName) {
    ...
    public DescriptorBuilder_setStartingMethodName showLog(boolean value) {
