    ...
    implements DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setPackage_setReturnType, BuilderImplementation
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setPackage_setReturnType(DescriptorHelper helper, BuilderImplementation returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setDescriptorName_setPackage_setReturnType enableCondensedClassNames() {
