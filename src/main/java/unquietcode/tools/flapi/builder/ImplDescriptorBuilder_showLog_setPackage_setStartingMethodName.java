...
public class ImplDescriptorBuilder_showLog_setPackage_setStartingMethodName
    extends ImplDescriptorBuilder
    implements DescriptorBuilder_showLog_setPackage_setStartingMethodName
{


    ImplDescriptorBuilder_showLog_setPackage_setStartingMethodName(DescriptorHelper helper, Object returnValue) {
