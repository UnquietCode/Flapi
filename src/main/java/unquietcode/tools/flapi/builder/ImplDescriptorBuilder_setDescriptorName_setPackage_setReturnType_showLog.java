 ...
 * 
 */
public class ImplDescriptorBuilder_setDescriptorName_setPackage_setReturnType_showLog
    implements DescriptorBuilder_setDescriptorName_setPackage_setReturnType_showLog
{
    ...
    ImplDescriptorBuilder_setDescriptorName_setPackage_setReturnType_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setPackage_setReturnType_showLog setDescriptorName(String descriptorName) {
    ...
    public DescriptorBuilder_setDescriptorName_setReturnType_showLog setPackage(String packageName) {
    ...
    public DescriptorBuilder_setDescriptorName_setPackage_showLog setReturnType(Class returnType) {
    ...
    public DescriptorBuilder_setDescriptorName_setPackage_setReturnType showLog(boolean value) {
