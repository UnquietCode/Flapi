...
public interface DescriptorBuilder_setDescriptorName_setPackage<_ReturnType >{
    ...
    MethodBuilder_addBlockChain<BlockBuilder_exitWhenEmpty<DescriptorBuilder_setDescriptorName_setPackage<_ReturnType>>> startBlock(String blockName, String methodSignature);
