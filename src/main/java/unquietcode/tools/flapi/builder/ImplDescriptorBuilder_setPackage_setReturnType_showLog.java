 ...
 * 
 */
public class ImplDescriptorBuilder_setPackage_setReturnType_showLog
    implements DescriptorBuilder_setPackage_setReturnType_showLog
{
    ...
    ImplDescriptorBuilder_setPackage_setReturnType_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setReturnType_showLog setPackage(String packageName) {
    ...
    public DescriptorBuilder_setPackage_showLog setReturnType(Class returnType) {
    ...
    public DescriptorBuilder_setPackage_setReturnType showLog(boolean value) {
