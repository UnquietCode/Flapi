...
public class ImplDescriptorBuilder_setDescriptorName_setReturnType_setStartingMethodName
    implements DescriptorBuilder_setDescriptorName_setReturnType_setStartingMethodName, BuilderImplementation
{
    ...
    ImplDescriptorBuilder_setDescriptorName_setReturnType_setStartingMethodName(DescriptorHelper helper, BuilderImplementation returnValue) {
        _helper = helper;
