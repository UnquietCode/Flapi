...
public interface DescriptorBuilder_setDescriptorName_setReturnType_setStartingMethodName<_ReturnType >{
    ...
    MethodBuilder_addBlockChain<DescriptorBuilder_setDescriptorName_setReturnType_setStartingMethodName<_ReturnType>> addBlockReference(String blockName, String methodSignature);

    Descriptor build();

    DescriptorBuilder_setDescriptorName_setReturnType<_ReturnType> setStartingMethodName(String methodName);

    MethodBuilder_addBlockChain<BlockBuilder<DescriptorBuilder_setDescriptorName_setReturnType_setStartingMethodName<_ReturnType>>> startBlock(String methodSignature);
