 ...
 * 
 */
public class ImplDescriptorBuilder_setDescriptorName_setReturnType_setStartingMethodName_showLog
    implements DescriptorBuilder_setDescriptorName_setReturnType_setStartingMethodName_showLog
{
    ...
    ImplDescriptorBuilder_setDescriptorName_setReturnType_setStartingMethodName_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setReturnType_setStartingMethodName_showLog setDescriptorName(String descriptorName) {
    ...
    public DescriptorBuilder_setDescriptorName_setStartingMethodName_showLog setReturnType(Class returnType) {
    ...
    public DescriptorBuilder_setDescriptorName_setReturnType_showLog setStartingMethodName(String methodName) {
