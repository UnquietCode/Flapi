...
public interface DescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType<_ReturnType >{
    ...
    MethodBuilder_addBlockChain<BlockBuilder_exitWhenEmpty<DescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType<_ReturnType>>> startBlock(String blockName, String methodSignature);

    DescriptorBuilder_setPackage_setReturnType<_ReturnType> enableCondensedClassNames(boolean value);
