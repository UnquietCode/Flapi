...
public interface DescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType<_ReturnType >{
    ...
    MethodBuilder_addBlockChain<BlockBuilder<DescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType<_ReturnType>>> startBlock(String methodSignature);
    ...
    MethodBuilder_addBlockChain<DescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType<_ReturnType>> addBlockReference(String blockName, String methodSignature);
