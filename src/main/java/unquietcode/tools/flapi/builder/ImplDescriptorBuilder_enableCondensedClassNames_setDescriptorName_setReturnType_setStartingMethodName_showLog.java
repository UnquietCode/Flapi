 ...
 * 
 */
public class ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setReturnType_setStartingMethodName_showLog
    implements DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setReturnType_setStartingMethodName_showLog
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setReturnType_setStartingMethodName_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setDescriptorName_setReturnType_setStartingMethodName_showLog enableCondensedClassNames(boolean value) {
        _helper.enableCondensedClassNames(value);
         
        DescriptorBuilder_setDescriptorName_setReturnType_setStartingMethodName_showLog retval = new ImplDescriptorBuilder_setDescriptorName_setReturnType_setStartingMethodName_showLog(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_setReturnType_setStartingMethodName_showLog setDescriptorName(String descriptorName) {
        _helper.setDescriptorName(descriptorName);
         
        DescriptorBuilder_enableCondensedClassNames_setReturnType_setStartingMethodName_showLog retval = new ImplDescriptorBuilder_enableCondensedClassNames_setReturnType_setStartingMethodName_showLog(_helper, _returnValue);
        --ic_Descriptor_setDescriptorName$String_descriptorName;
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setStartingMethodName_showLog setReturnType(Class returnType) {
    ...
    public DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setReturnType_showLog setStartingMethodName(String methodName) {
        _helper.setStartingMethodName(methodName);
         
        DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setReturnType_showLog retval = new ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setReturnType_showLog(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setReturnType_setStartingMethodName showLog(boolean value) {
