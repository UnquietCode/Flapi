 ...
 * 
 */
public class ImplDescriptorBuilder_setDescriptorName_setReturnType_showLog
    implements DescriptorBuilder_setDescriptorName_setReturnType_showLog
{
    ...
    ImplDescriptorBuilder_setDescriptorName_setReturnType_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setReturnType_showLog setDescriptorName(String descriptorName) {
