 ...
 * 
 */
public class ImplDescriptorBuilder_enableCondensedClassNames_setStartingMethodName_showLog
    implements DescriptorBuilder_enableCondensedClassNames_setStartingMethodName_showLog
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setStartingMethodName_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setStartingMethodName_showLog enableCondensedClassNames(boolean value) {
        _helper.enableCondensedClassNames(value);
         
        DescriptorBuilder_setStartingMethodName_showLog retval = new ImplDescriptorBuilder_setStartingMethodName_showLog(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_showLog setStartingMethodName(String methodName) {
        _helper.setStartingMethodName(methodName);
         
        DescriptorBuilder_enableCondensedClassNames_showLog retval = new ImplDescriptorBuilder_enableCondensedClassNames_showLog(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_setStartingMethodName showLog(boolean value) {
