 ...
 * 
 */
public class ImplDescriptorBuilder_enableCondensedClassNames_setReturnType_showLog
    implements DescriptorBuilder_enableCondensedClassNames_setReturnType_showLog
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setReturnType_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setReturnType_showLog enableCondensedClassNames(boolean value) {
    ...
    public DescriptorBuilder_enableCondensedClassNames_showLog setReturnType(Class returnType) {
    ...
    public DescriptorBuilder_enableCondensedClassNames_setReturnType showLog(boolean value) {
