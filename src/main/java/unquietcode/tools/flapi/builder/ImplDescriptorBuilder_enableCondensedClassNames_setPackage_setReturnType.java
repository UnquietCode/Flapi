...
public class ImplDescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType
    implements DescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType, BuilderImplementation
{
    ...
    public DescriptorBuilder_setPackage_setReturnType enableCondensedClassNames() {
