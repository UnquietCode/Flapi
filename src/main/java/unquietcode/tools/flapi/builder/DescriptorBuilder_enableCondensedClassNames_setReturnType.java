...
public interface DescriptorBuilder_enableCondensedClassNames_setReturnType<_ReturnType >{
    ...
    DescriptorBuilder_setReturnType<_ReturnType> enableCondensedClassNames();

    MethodBuilder_addBlockChain<BlockBuilder<DescriptorBuilder_enableCondensedClassNames_setReturnType<_ReturnType>>> startBlock(String methodSignature);

    MethodBuilder_addBlockChain<DescriptorBuilder_enableCondensedClassNames_setReturnType<_ReturnType>> addBlockReference(String blockName, String methodSignature);
