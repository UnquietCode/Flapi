 ...
 * 
 */
public class ImplDescriptorBuilder_enableCondensedClassNames_setPackage_showLog
    implements DescriptorBuilder_enableCondensedClassNames_setPackage_showLog
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setPackage_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setPackage_showLog enableCondensedClassNames(boolean value) {
    ...
    public DescriptorBuilder_enableCondensedClassNames_showLog setPackage(String packageName) {
    ...
    public DescriptorBuilder_enableCondensedClassNames_setPackage showLog(boolean value) {
