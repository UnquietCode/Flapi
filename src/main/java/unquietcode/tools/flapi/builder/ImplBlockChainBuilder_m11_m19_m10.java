...
public class ImplBlockChainBuilder_m11_m19_m10
    implements BlockChainBuilder_m11_m19_m10, BuilderImplementation
{

    private final BlockChainHelper _helper;
    private final Object _returnValue;

    ImplBlockChainBuilder_m11_m19_m10(BlockChainHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public BlockChainBuilder_m11_m19_m10 addBlockChain() {
        ObjectWrapper<BlockChainHelper> helper1 = new ObjectWrapper<BlockChainHelper>();
        _helper.addBlockChain(helper1);
        ImplBlockChainBuilder_m19_m10 step1 = new ImplBlockChainBuilder_m19_m10(_helper, _returnValue);
        ImplBlockChainBuilder_m11_m19_m10 step2 = new ImplBlockChainBuilder_m11_m19_m10(helper1 .get(), step1);
