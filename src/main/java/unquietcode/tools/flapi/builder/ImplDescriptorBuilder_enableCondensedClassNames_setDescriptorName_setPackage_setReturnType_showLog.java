 ...
 * 
 */
public class ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setPackage_setReturnType_showLog
    implements DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setPackage_setReturnType_showLog
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setPackage_setReturnType_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setDescriptorName_setPackage_setReturnType_showLog enableCondensedClassNames(boolean value) {
        _helper.enableCondensedClassNames(value);
         
        DescriptorBuilder_setDescriptorName_setPackage_setReturnType_showLog retval = new ImplDescriptorBuilder_setDescriptorName_setPackage_setReturnType_showLog(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType_showLog setDescriptorName(String descriptorName) {
    ...
    public DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setReturnType_showLog setPackage(String packageName) {
    ...
    public DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setPackage_showLog setReturnType(Class returnType) {
    ...
    public DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setPackage_setReturnType showLog(boolean value) {
