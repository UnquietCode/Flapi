 ...
 * 
 */
public class ImplDescriptorBuilder_setPackage_setStartingMethodName_showLog
    implements DescriptorBuilder_setPackage_setStartingMethodName_showLog
{
    ...
    ImplDescriptorBuilder_setPackage_setStartingMethodName_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setStartingMethodName_showLog setPackage(String packageName) {
    ...
    public DescriptorBuilder_setPackage_showLog setStartingMethodName(String methodName) {
        _helper.setStartingMethodName(methodName);
         
        DescriptorBuilder_setPackage_showLog retval = new ImplDescriptorBuilder_setPackage_showLog(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_setPackage_setStartingMethodName showLog(boolean value) {
        _helper.showLog(value);
         
        DescriptorBuilder_setPackage_setStartingMethodName retval = new ImplDescriptorBuilder_setPackage_setStartingMethodName(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }
