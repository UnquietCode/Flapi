 ...
 * 
 */
public class ImplDescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType_showLog
    implements DescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType_showLog
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setPackage_setReturnType_showLog enableCondensedClassNames(boolean value) {
        _helper.enableCondensedClassNames(value);
         
        DescriptorBuilder_setPackage_setReturnType_showLog retval = new ImplDescriptorBuilder_setPackage_setReturnType_showLog(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_setReturnType_showLog setPackage(String packageName) {
    ...
    public DescriptorBuilder_enableCondensedClassNames_setPackage_showLog setReturnType(Class returnType) {
        _helper.setReturnType(returnType);
         
        DescriptorBuilder_enableCondensedClassNames_setPackage_showLog retval = new ImplDescriptorBuilder_enableCondensedClassNames_setPackage_showLog(_helper, _returnValue);
        --ic_Descriptor_setReturnType$Class_returnType;
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType showLog(boolean value) {
        _helper.showLog(value);
         
        DescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType retval = new ImplDescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }
