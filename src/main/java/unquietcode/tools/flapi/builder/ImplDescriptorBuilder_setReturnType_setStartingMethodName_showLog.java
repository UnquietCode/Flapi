 ...
 * 
 */
public class ImplDescriptorBuilder_setReturnType_setStartingMethodName_showLog
    implements DescriptorBuilder_setReturnType_setStartingMethodName_showLog
{
    ...
    ImplDescriptorBuilder_setReturnType_setStartingMethodName_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setStartingMethodName_showLog setReturnType(Class returnType) {
    ...
    public DescriptorBuilder_setReturnType_showLog setStartingMethodName(String methodName) {
        _helper.setStartingMethodName(methodName);
         
        DescriptorBuilder_setReturnType_showLog retval = new ImplDescriptorBuilder_setReturnType_showLog(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }
    ...
    public DescriptorBuilder_setReturnType_setStartingMethodName showLog(boolean value) {
        ...
        DescriptorBuilder_setReturnType_setStartingMethodName retval = new ImplDescriptorBuilder_setReturnType_setStartingMethodName(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }
