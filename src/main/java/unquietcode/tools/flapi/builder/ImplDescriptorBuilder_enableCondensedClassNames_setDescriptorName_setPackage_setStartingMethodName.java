    ...
    implements DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setPackage_setStartingMethodName, BuilderImplementation
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setPackage_setStartingMethodName(DescriptorHelper helper, BuilderImplementation parent) {
        _helper = helper;
        _parent = parent;
    }
    ...
    public DescriptorBuilder_setDescriptorName_setPackage_setStartingMethodName enableCondensedClassNames() {
        ...
        DescriptorBuilder_setDescriptorName_setPackage_setStartingMethodName retval = new ImplDescriptorBuilder_setDescriptorName_setPackage_setStartingMethodName(_helper, _parent);
    ...
    public DescriptorBuilder_enableCondensedClassNames_setPackage_setStartingMethodName setDescriptorName(String descriptorName) {
        ...
        DescriptorBuilder_enableCondensedClassNames_setPackage_setStartingMethodName retval = new ImplDescriptorBuilder_enableCondensedClassNames_setPackage_setStartingMethodName(_helper, _parent);
        _transferInvocations(retval);
        return retval;
    }
    ...
    public DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setStartingMethodName setPackage(String packageName) {
        ...
        DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setStartingMethodName retval = new ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setStartingMethodName(_helper, _parent);
        _transferInvocations(retval);
        return retval;
    }
    ...
    public DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setPackage setStartingMethodName(String methodName) {
        ...
        DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setPackage retval = new ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setPackage(_helper, _parent);
        _transferInvocations(retval);
        return retval;
    }
