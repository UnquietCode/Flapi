...
public interface DescriptorBuilder_setStartingMethodName<_ReturnType >{
    ...
    MethodBuilder_addBlockChain<DescriptorBuilder_setStartingMethodName<_ReturnType>> addBlockReference(String blockName, String methodSignature);

    MethodBuilder_addBlockChain<BlockBuilder<DescriptorBuilder_setStartingMethodName<_ReturnType>>> startBlock(String methodSignature);
