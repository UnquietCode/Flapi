...
public interface DescriptorBuilder_setPackage<_ReturnType >{
    ...
    MethodBuilder_addBlockChain<BlockBuilder<DescriptorBuilder_setPackage<_ReturnType>>> startBlock(String methodSignature);

    DescriptorBuilder<_ReturnType> setPackage(String packageName);

    MethodBuilder_addBlockChain<DescriptorBuilder_setPackage<_ReturnType>> addBlockReference(String blockName, String methodSignature);
