 ...
 * 
 */
public class ImplDescriptorBuilder_enableCondensedClassNames_showLog
    implements DescriptorBuilder_enableCondensedClassNames_showLog
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_showLog enableCondensedClassNames(boolean value) {
        _helper.enableCondensedClassNames(value);
         
        DescriptorBuilder_showLog retval = new ImplDescriptorBuilder_showLog(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames showLog(boolean value) {
