...
public class ImplDescriptorBuilder_setPackage_setReturnType_setStartingMethodName
    implements DescriptorBuilder_setPackage_setReturnType_setStartingMethodName, BuilderImplementation
{
    ...
    ImplDescriptorBuilder_setPackage_setReturnType_setStartingMethodName(DescriptorHelper helper, BuilderImplementation returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setPackage_setReturnType setStartingMethodName(String methodName) {
