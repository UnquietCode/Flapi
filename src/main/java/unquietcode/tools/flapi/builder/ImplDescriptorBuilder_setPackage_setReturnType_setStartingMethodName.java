...
public class ImplDescriptorBuilder_setPackage_setReturnType_setStartingMethodName
    implements DescriptorBuilder_setPackage_setReturnType_setStartingMethodName
{
    ...
    ImplDescriptorBuilder_setPackage_setReturnType_setStartingMethodName(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
