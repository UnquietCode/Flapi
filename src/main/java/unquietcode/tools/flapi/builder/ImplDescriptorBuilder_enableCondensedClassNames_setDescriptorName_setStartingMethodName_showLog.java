 ...
 * 
 */
public class ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setStartingMethodName_showLog
    implements DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setStartingMethodName_showLog
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName_setStartingMethodName_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setDescriptorName_setStartingMethodName_showLog enableCondensedClassNames(boolean value) {
        _helper.enableCondensedClassNames(value);
         
        DescriptorBuilder_setDescriptorName_setStartingMethodName_showLog retval = new ImplDescriptorBuilder_setDescriptorName_setStartingMethodName_showLog(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_setStartingMethodName_showLog setDescriptorName(String descriptorName) {
    ...
    public DescriptorBuilder_enableCondensedClassNames_setDescriptorName_showLog setStartingMethodName(String methodName) {
    ...
    public DescriptorBuilder_enableCondensedClassNames_setDescriptorName_setStartingMethodName showLog(boolean value) {
