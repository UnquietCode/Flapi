...
public class ImplDescriptorBuilder_enableCondensedClassNames_setPackage_setStartingMethodName
    implements DescriptorBuilder_enableCondensedClassNames_setPackage_setStartingMethodName
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setPackage_setStartingMethodName(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public DescriptorBuilder_setPackage_setStartingMethodName enableCondensedClassNames(boolean value) {
