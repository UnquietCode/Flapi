...
public class ImplDescriptorBuilder_enableCondensedClassNames_setPackage_setStartingMethodName
    implements DescriptorBuilder_enableCondensedClassNames_setPackage_setStartingMethodName, BuilderImplementation
{
    ...
    ImplDescriptorBuilder_enableCondensedClassNames_setPackage_setStartingMethodName(DescriptorHelper helper, BuilderImplementation parent) {
        _helper = helper;
        _parent = parent;
    }
    ...
    public DescriptorBuilder_setPackage_setStartingMethodName enableCondensedClassNames() {
        _helper.enableCondensedClassNames();
         
        DescriptorBuilder_setPackage_setStartingMethodName retval = new ImplDescriptorBuilder_setPackage_setStartingMethodName(_helper, _parent);
        _transferInvocations(retval);
        return retval;
    }

    public DescriptorBuilder_enableCondensedClassNames_setStartingMethodName setPackage(String packageName) {
    ...
    public DescriptorBuilder_enableCondensedClassNames_setPackage setStartingMethodName(String methodName) {
        _helper.setStartingMethodName(methodName);
         
        DescriptorBuilder_enableCondensedClassNames_setPackage retval = new ImplDescriptorBuilder_enableCondensedClassNames_setPackage(_helper, _parent);
        _transferInvocations(retval);
        return retval;
    }
