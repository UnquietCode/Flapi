...
public class ImplDescriptorBuilder_enableCondensedClassNames_setDescriptorName
    implements DescriptorBuilder_enableCondensedClassNames_setDescriptorName
{
    ...
    public DescriptorBuilder_setDescriptorName enableCondensedClassNames(boolean value) {
