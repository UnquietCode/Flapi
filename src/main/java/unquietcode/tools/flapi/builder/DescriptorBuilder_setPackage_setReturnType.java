...
public interface DescriptorBuilder_setPackage_setReturnType<_ReturnType >{
    ...
    MethodBuilder_addBlockChain<BlockBuilder_exitWhenEmpty<DescriptorBuilder_setPackage_setReturnType<_ReturnType>>> startBlock(String blockName, String methodSignature);
