 ...
 * 
 */
public class ImplDescriptorBuilder_setReturnType_showLog
    implements DescriptorBuilder_setReturnType_showLog
{
    ...
    ImplDescriptorBuilder_setReturnType_showLog(DescriptorHelper helper, Object returnValue) {
        _helper = helper;
