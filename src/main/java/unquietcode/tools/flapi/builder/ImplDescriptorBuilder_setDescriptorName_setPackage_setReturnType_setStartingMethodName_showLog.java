    ...
    implements DescriptorBuilder_setDescriptorName_setPackage_setReturnType_setStartingMethodName_showLog
{
    ...
    public DescriptorBuilder_setPackage_setReturnType_setStartingMethodName_showLog setDescriptorName(String descriptorName) {
    ...
    public DescriptorBuilder_setDescriptorName_setReturnType_setStartingMethodName_showLog setPackage(String packageName) {
    ...
    public DescriptorBuilder_setDescriptorName_setPackage_setStartingMethodName_showLog setReturnType(Class returnType) {
    ...
    public DescriptorBuilder_setDescriptorName_setPackage_setReturnType_showLog setStartingMethodName(String methodName) {
    ...
    public DescriptorBuilder_setDescriptorName_setPackage_setReturnType_setStartingMethodName showLog(boolean value) {
