...
public interface DescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType_setStartingMethodName<_ReturnType >{
    ...
    MethodBuilder_addBlockChain<BlockBuilder<DescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType_setStartingMethodName<_ReturnType>>> startBlock(String methodSignature);
    ...
    MethodBuilder_addBlockChain<DescriptorBuilder_enableCondensedClassNames_setPackage_setReturnType_setStartingMethodName<_ReturnType>> addBlockReference(String blockName, String methodSignature);
