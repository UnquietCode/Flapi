...
public interface DescriptorBuilder_setReturnType<_ReturnType >{
    ...
    MethodBuilder_addBlockChain<BlockBuilder<DescriptorBuilder_setReturnType<_ReturnType>>> startBlock(String methodSignature);

    Descriptor build();

    MethodBuilder_addBlockChain<DescriptorBuilder_setReturnType<_ReturnType>> addBlockReference(String blockName, String methodSignature);
