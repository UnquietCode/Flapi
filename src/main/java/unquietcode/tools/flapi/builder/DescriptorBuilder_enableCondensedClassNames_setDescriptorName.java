...
public interface DescriptorBuilder_enableCondensedClassNames_setDescriptorName<_ReturnType >{
    ...
    MethodBuilder_addBlockChain<BlockBuilder_exitWhenEmpty<DescriptorBuilder_enableCondensedClassNames_setDescriptorName<_ReturnType>>> startBlock(String blockName, String methodSignature);

    DescriptorBuilder_setDescriptorName<_ReturnType> enableCondensedClassNames(boolean value);
